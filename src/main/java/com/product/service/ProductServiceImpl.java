...
public class ProductServiceImpl implements ProductService {
	...
	//	ProductEntity productEntity  =productRepositry.findProductByID(productId);
		Optional<ProductEntity> productEntity  =productRepositry.findById(productId);
//		ProductObject productObject = new ProductObject();
		
//		productObject.setName(productEntity.getName());
//		productObject.setPrice(productEntity.getPrice());
//		productObject.setDescription(productEntity.getDescription());
